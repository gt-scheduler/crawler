...
const courseLocations = new Map([
  ...
  ['Mason', new Location(33.776764, -84.398440)],
  ['Love (MRDC II)', new Location(33.776720, -84.401764)],
  ['MRDC', new Location(33.777187, -84.400484)],
  ['Sustainable Education', new Location(33.776220, -84.397959)],
  ...
  ['760 Spring Street', new Location(33.775610, -84.389060)],
  ...
  ['Stephen C Hall', new Location(33.774134, -84.393960)],
  ['Brittain T Room', new Location(33.772470, -84.391271)],
  ['Hefner Dormitory(HEF)', new Location(33.779159, -84.403952)],
  ['Old Civil Engr', new Location(33.774200, -84.394637)],
  ...
  ['J. S. Coon', new Location(33.772580, -84.395624)],
...
export function parse(html: string, version: number): TermData {
  ...
  let DEBUG_missed_locations = new Map();
  ...
  sections.forEach(section => {
    ...
    const meetings = meetingParts.map<Meeting>(meetingPart => {
      ...
      if (locationName) {
        ...
        DEBUG_missed_locations.set(where, false);
      }
  ...
  if (DEBUG_missed_locations.size > 0) {
    console.log('Unknown class locations:');
    console.log(DEBUG_missed_locations.keys());
  }
